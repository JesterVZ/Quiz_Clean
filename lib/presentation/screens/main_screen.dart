...
class _MainPage extends State<MainPage> {
  ...
  void initState() {
    navigatorList.add(TabNavigator(
        navigatorKey: _navKeys[TabItem.main], rootPage: HomeTab()));
    navigatorList.add(TabNavigator(
        navigatorKey: _navKeys[TabItem.feed], rootPage: FeedTab()));
    navigatorList.add(TabNavigator(
        navigatorKey: _navKeys[TabItem.profile], rootPage: ProfileTab()));
    super.initState();
  }
